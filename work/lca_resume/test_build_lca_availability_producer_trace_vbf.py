...
def test_availability_producer_trace_retains_only_proven_bypasses():
    m=importlib.import_module('build_lca_availability_producer_trace_vbf')
    ...
    assert m.TRACE_HANDLER[:2]==(0xE085,0xD0B6)
