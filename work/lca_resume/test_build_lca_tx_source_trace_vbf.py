...
def test_tx_source_trace_retains_only_proven_bypasses():
    m=importlib.import_module('build_lca_tx_source_trace_vbf')
    ...
    assert m.TRACE_HANDLER[:2]==(0xE084,0xD0B6)
    assert m.TRACE_SOURCES==(0x2DDE,0x2DB9,0x2D53,0x2DAF,0x7EBB,0x3F5B,0x220F)
